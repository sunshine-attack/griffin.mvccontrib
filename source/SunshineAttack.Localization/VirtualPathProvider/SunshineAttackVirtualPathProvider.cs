...
namespace SunshineAttack.Localization.VirtualPathProvider
{
    ...
    /// <example>
    /// <code>
    /// // you can assign a custom SunshineAttackWebViewPage or a custom layout.
    ...
    public class SunshineAttackVirtualPathProvider : System.Web.Hosting.VirtualPathProvider
    {
        private static readonly SunshineAttackVirtualPathProvider Instance = new SunshineAttackVirtualPathProvider();
        private readonly List<IViewFileProvider> _fileProviders = new List<IViewFileProvider>();
        private readonly ILogger _logger = LogProvider.Current.GetLogger<SunshineAttackVirtualPathProvider>();

        /// <summary>
        ///   Initializes a new instance of the <see cref="SunshineAttackVirtualPathProvider" /> class.
        /// </summary>
        private SunshineAttackVirtualPathProvider()
        {
        }
        ...
        ///   Gets singleton
        /// </summary>
        public static SunshineAttackVirtualPathProvider Current
        {
            get { return Instance; }
        }
